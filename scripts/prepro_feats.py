...
if __name__ == "__main__":
  ...
  parser.add_argument('--output_dir', default='data', help='output numpy file')

  # options
  parser.add_argument('--images_root', default='', help='root location in which images are stored, to be prepended to '
                                                        'file_path in input json')
  parser.add_argument('--att_size', default=14, type=int, help='14x14 or 7x7')
  parser.add_argument('--no_att', action="store_true", help='Not storing attention features to save space / time')
