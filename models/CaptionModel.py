...
class CaptionModel(nn.Module):
    ...
    def forward(self, *args, **kwargs):
        ...
        if 'mode' in kwargs:
            del kwargs['mode']
        # this can call "_sample()" or "_forward()"
        # and _sample() will call _sample_beam(), which will call beam_search()
        return getattr(self, '_'+mode)(*args, **kwargs)

    # DBS: https://arxiv.org/abs/1610.02424
    def beam_search(self, init_state, init_logprobs, *args, **kwargs):
        ...
        for t in range(self.seq_length + group_size - 1):
            for divm in range(group_size): # for our purpose, let's suppose group_size = 1
                if t >= divm and t <= self.seq_length + divm - 1:
                    ...
                    # TODO: to modify probability, RSA incremental decoding should happen here...
                    # TODO: OR, happen inside add_diversity...
